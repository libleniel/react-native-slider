          ...
          return _ret = (
               _temp = (
                    _this = _possibleConstructorReturn(
                              this,
                              (
                                   _Object$getPrototypeO = Object.getPrototypeOf(Slider)
               ...
               // Should we become active when the user presses down on the thumb?
               ...
               }, _this._handlePanResponderGrant  =function() /*e: Object, gestureState: Object*/ {
                    ...
                    if (_this.props.step) {
                         return Math.max(
                              ...
                              Math.min(
                                   ...
                                   _this.props.minimumValue + Math.round(
                                        ratio * (
                    ...
                    if (state.allMeasured === true) {
                         size.width = Math.max(
                              0, props.thumbTouchSize.width-state.thumbSize.width
                         );
               ...
               }, this._getThumbTouchRect = function() {
                    var state = _this.state;
                    var props = _this.props;
                    ...
                    return _react2.default.createElement(
                         _reactNative.Image, {
                              source: thumbImage,
                              __source: {
                                   fileName: _jsxFileName, lineNumber:518
                              }
                         }
                    );
               }, _temp
          ...
          [
               ...
               },
               {
                    ...
                    value: function componentDidUpdate(prevProps) {
                         var newValue = this.state.rawValue;
                         var oldValue = prevProps.rawValue;
                         ...
                         return _react2.default.createElement(
                              ...
                              _react2.default.createElement(
                                   _reactNative.Animated.View,
                                   {
                                        renderToHardwareTextureAndroid: true,
                                        style: [
                                             mainStyles.track,trackStyle,minimumTrackStyle
                                        ],
                                        __source: {
                                             fileName: _jsxFileName,
                                             lineNumber: 270
               ...
               },
               {
                    ...
                    value: function _getPropsForComponentUpdate(props) {
                         ...
                         var otherProps = _objectWithoutProperties(
                              props,
                              [
                                   "value",
                                   "onValueChange",
               ...
               },
               {
                    ...
                    value: function _handleMoveShouldSetPanResponder() { // Should we become active when the user moves a touch over the thumb?
                         return false;
                    }
               },
               {
                    key: "_handlePanResponderRequestEnd",
                    value: function _handlePanResponderRequestEnd(e,gestureState) { // Should we allow another component to take over this pan?
                         return false;
                    }
               }
          ], 
...
Slider.propTypes = { /**
     ...
     * * You must set this if you set the value
     * Unprocessed value that has the same value as "value"
     */rawValue: _propTypes2.default.number, /**
...
var defaultStyles = _reactNative.StyleSheet.create({
     ...
     track: {
          height: TRACK_SIZE, borderRadius:TRACK_SIZE / 2
     },
     thumb:{
          position: 'absolute',
          width: THUMB_SIZE,
